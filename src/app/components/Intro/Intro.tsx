        ...
        <Grid container spacing={4} justifyContent="center">
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="h6" sx={{ marginTop: 2, color: '#555' }}>
              We are a leading software development company focused on creating innovative
              solutions for businesses across various industries.
            </Typography>
            <Typography variant="body1" sx={{ marginTop: 2, color: '#666' }}>
              Our mission is to help businesses streamline their operations and scale with cutting-edge technology.
            </Typography>
            <Box sx={{ marginTop: 4 }}>
              <Button
                variant="contained"
